...
import { AST_Node, AST_Scope, AST_Toplevel, walk } from "./ast.js";
...
var to_ascii = typeof atob == "undefined"
  ...
  : atob;
var to_base64 = typeof btoa == "undefined"
  ? function (str) {
...
function log_input(files, options, fs, debug_folder) {
  ...
  const files_str = (file) => {
    if (
      typeof file === "object" && options.parse && options.parse.spidermonkey
    ) {
...
async function minify(files, options, _fs_module) {
  if (
    ...
    process.env &&
    typeof Deno.env.get("TERSER_DEBUG_DIR") === "string"
  ) {
    log_input(files, options, _fs_module, Deno.env.get("TERSER_DEBUG_DIR"));
  }
