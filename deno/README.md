...
- `keep_classnames` (default: `undefined`) - pass `true` to prevent discarding
...
- `pure_funcs` (default: `null`) -- You can pass an array of names and Terser
